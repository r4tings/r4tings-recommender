 ...
 */
package com.r4tings.recommender.examples.ch04.binary;
...
public class ExtendedJaccardSimilarityTest extends AbstractSparkTests {
  ...
  @ParameterizedTest
  @CsvSource({
    "'dataset/r4tings, ratings.parquet', ' , BINARY_THRESHOLDING, , , , 3d', USER, true, true, 'u4, u5, 0.1428'",
    "'dataset/r4tings, ratings.parquet', ' , BINARY_THRESHOLDING, , , , 3d', ITEM, true, true, 'i3, i1, 0.3333'",
//  "'dataset/r4tings, ratings.parquet', ' , BINARY_THRESHOLDING, , , , 3d', USER,     , true, 'u4, u5, 0.4999'",
