...
“**R4tings Recommender Examples**”는 “**[R4tings Recommender](https://github.com/r4tings/r4tings-recommender)**” 오픈 소스 추천 엔진의 활용 예제들을 제공합니다.
...
# "Remove-Item -recurse r4tings"를 입력하고 실행하여 r4tings 폴더가 이미 존재한다면 삭제합니다.

Remove-Item -recurse r4tings

# "mkdir r4tings"를 입력하고 실행하여 r4tings 폴더를 생성합니다.

mkdir r4tings

# "cd r4tings"를 입력하고 실행하여 r4tings 폴더로 이동합니다.
...
<#
  R4tings Recommender와 R4tings Recommender Examples 리파지토리의 GitHub 소스 코드 보관 파일을 내려받기 위해  
  "curl "https://github.com/r4tings/r4tings-recommender/archive/refs/heads/master.zip" -o r4tings-recommender-master.zip"와 
  "curl "https://github.com/r4tings/r4tings-recommender-examples/archive/refs/heads/master.zip" -o r4tings-recommender-examples-master.zip" 를 입력하여 실행합니다.
#>

curl "https://github.com/r4tings/r4tings-recommender/archive/refs/heads/master.zip" -o r4tings-recommender-master.zip

curl "https://github.com/r4tings/r4tings-recommender-examples/archive/refs/heads/master.zip" -o r4tings-recommender-examples-master.zip
...
<#
  내려받은 소스 코드 보관 파일들의 압축 해제를 위해 
  "Expand-Archive -LiteralPath r4tings-recommender-master.zip -DestinationPath ."와 
  "Expand-Archive -LiteralPath r4tings-recommender-examples-master.zip -DestinationPath ."를 입력하여 실행합니다.
#>

Expand-Archive -LiteralPath r4tings-recommender-master.zip -DestinationPath .                  

Expand-Archive -LiteralPath r4tings-recommender-examples-master.zip -DestinationPath .         

<#
  압축이 해제된 폴더의 이름을 변경하기 위해 
  "Rename-Item -Path r4tings-recommender-master -NewName r4tings-recommender"와 
  "Rename-Item -Path r4tings-recommender-examples-master -NewName r4tings-recommender-examples"를 입력하여 실행합니다.
#>

Rename-Item -Path r4tings-recommender-examples-master -NewName r4tings-recommender-examples   

Rename-Item -Path r4tings-recommender-master -NewName r4tings-recommender                      

# r4tings 폴더를 살펴봅니다.

ls

# "cd r4tings-recommender-examples"를 입력하고 실행하여 r4tings-recommender-examples 폴더로 이동합니다.

cd r4tings-recommender-examples

# r4tings-recommender-examples 폴더를 살펴봅니다.
...
# 예제 데이터셋(r4tings)을 CSV 형식에서 Parquet 형식으로 변환합니다.
...
설치와 구성에 대한 자세한 설명은 각 링크에서 확인할 수 있습니다.
...
### R4tings Recommender와 R4tings Recommender Examples 프로젝트 내려받기 

R4tings Recommender Examples는 필수 소프트웨어인 JDK 11의 설치와 구성이 사전에 완료되었다고 가정합니다. 
...
⑤ R4tings Recommender와 R4tings Recommender Examples 리파지토리의 GitHub 소스 코드 보관 파일을 내려받기 위해 "curl "https://github.com/r4tings/r4tings-recommender/archive/refs/heads/master.zip" -o r4tings-recommender-master.zip"와 "curl "https://github.com/r4tings/r4tings-recommender-examples/archive/refs/heads/master.zip" -o r4tings-recommender-examples-master.zip"를 입력하여 실행합니다.

⑥ 내려받은 소스 코드 보관 파일들의 압축 해제를 위해 "Expand-Archive -LiteralPath r4tings-recommender-master.zip -DestinationPath ."와 "Expand-Archive -LiteralPath r4tings-recommender-examples-master.zip -DestinationPath ."를 입력하여 실행합니다.

⑦ 압축이 해제된 폴더의 이름을 변경하기 위해 "Rename-Item -Path r4tings-recommender-master -NewName r4tings-recommender"와 "Rename-Item -Path r4tings-recommender-examples-master -NewName r4tings-recommender-examples"를 입력하여 실행합니다.

⑧ 마지막으로 "ls"를 입력하고 실행하여 r4tings 폴더의 내용을 확인합니다.
...
----                 -------------         ------ ----
d-----      2023-09-02  오후 11:36                r4tings


PS C:\> cd r4tings
PS C:\r4tings> curl "https://github.com/r4tings/r4tings-recommender/archive/refs/heads/master.zip" -o r4tings-recommender-master.zip
PS C:\r4tings> curl "https://github.com/r4tings/r4tings-recommender-examples/archive/refs/heads/master.zip" -o r4tings-recommender-examples-master.zip
PS C:\r4tings> ls
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
-a----      2023-09-02  오후 11:24         358341 r4tings-recommender-examples-master.zip
-a----      2023-09-02  오후 11:24         300804 r4tings-recommender-master.zip
...
PS C:\r4tings> Expand-Archive -LiteralPath r4tings-recommender-examples-master.zip -DestinationPath .
PS C:\r4tings> Rename-Item -Path r4tings-recommender-examples-master -NewName r4tings-recommender-examples
PS C:\r4tings> ls
...
Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
d-----      2023-09-02  오후 11:24                r4tings-recommender
d-----      2023-09-02  오후 11:25                r4tings-recommender-examples
-a----      2023-09-02  오후 11:24         358341 r4tings-recommender-examples-master.zip
-a----      2023-09-02  오후 11:24         300804 r4tings-recommender-master.zip


PS C:\r4tings> cd r4tings-recommender-examples
PS C:\r4tings\r4tings-recommender-examples> ls


    디렉터리: C:\r4tings\r4tings-recommender-examples


Mode                 LastWriteTime         Length Name
----                 -------------         ------ ----
d-----      2023-09-02  오후 10:49                dataset
d-----      2023-09-02  오후 10:49                gradle
d-----      2023-09-02  오후 10:49                hadoop-2.8.3
d-----      2023-09-02  오후 10:49                src
-a----      2023-09-02   오전 1:26            221 .gitignore
-a----      2023-09-02   오전 1:26           5939 build.gradle.kts
-a----      2023-09-02   오전 1:26           2148 CONTRIBUTORS.md
-a----      2023-09-02   오전 1:26            207 gradle.properties
-a----      2023-09-02   오전 1:26           5770 gradlew
-a----      2023-09-02   오전 1:26           2954 gradlew.bat
-a----      2023-09-02   오전 1:26         122153 README.md
-a----      2023-09-02   오전 1:26            157 settings.gradle.kts


PS C:\r4tings\r4tings-recommender-examples> ./gradlew clean build -x test
⋯ - 일부 생략 -
PS C:\r4tings\r4tings-recommender-examples> ./gradlew :test --tests com.r4tings.recommender.examples.ch02.DatasetLoadTest.r4tingsDatasetExamples
⋯ - 일부 생략 -
```

<br/>

### R4tings Recommender Examples와 R4tings Recommender 프로젝트 살펴보기

<br/>

R4tings Recommender를 포함하는 R4tings Recommender Examples 프로젝트의 폴더 구조는 다음과 같습니다

```
├── r4tings-recommender-master.zip                   <- R4tings Recommender 소스 코드 보관 파일
├── r4tings-recommender-examples-master.zip          <- R4tings Recommender Examples 소스 코드 보관 파일
│
...
│
└── r4tings-recommender-examples                     <- R4tings Recommender Examples 프로젝트
    ├── dataset                                      <- 예제 데이터셋
...
> **Warning**
> 
> 프로젝트 폴더 명에는 **-master**가 없습니다.
> 
> 프로젝트 폴더는 r4tings-recommender와 r4tings-recommender-examples 폴더입니다.
> 
...
### R4tings Recommender Examples 프로젝트를 Gradle로 빌드하기
...
[**DatasetLoadTest**](./src/test/java/com/r4tings/recommender/examples/ch02/DatasetLoadTest.java) 클래스는 데이터 파일을 읽어 들여 확인하기 위해 JUnit으로 작성된 예제 소스 코드입니다.

CSV 파일 형식의 예제 데이터셋을 로드하여 Parquet 형식으로 저장합니다.

> Apache Spark는 CSV와 Parquet 파일 형식 모두 지원하지만, 여기에서는 Raw 데이터를 전처리한다는 가정하에 CSV 형식의 데이터셋 파일을 읽어들여 Parquet 형식으로 변환합니다.
...
예제 데이터셋(r4tings)은 설명을 위해 사용되는 데이터셋입니다. R4tings Recommender Examples 프로젝트의 dataset/r4tings 폴더 구조는 다음과 같습니다 

```
├── r4tings-recommender-examples
    ├── dataset                                      <- 예제 데이터셋
    │   ├── r4tings                                  <- r4tings 데이터셋
    │   │   ├── items.csv                            <- 아이템 데이터 (CSV 형식)
    │   │   ├── ratings.csv                          <- 평점   데이터 (CSV 형식) 
    │   │   ├── tags.csv                             <- 태그   데이터 (CSV 형식)  
    │   │   └── terms.csv                            <- 단어   데이터 (CSV 형식)    
    │   │    
    │   ⋯ - 일부 생략 - 
```
<br/>

##### 예제 데이터셋 Parquet로 변환하기
...
다음과 같이 명령줄 인터페이스(CLI, Command line interface)에서 빌드 도구인 Gradle Wrapper로 DatasetLoadTest 클래스의 테스트 메서드인 r4tingsDatasetExamples를 실행해 봅니다.
...
![Download](src/test/puml/ch03/MinMaxNormalizer_Class_Diagram.svg)
...
<img src="src/test/puml/ch03/minMaxExamples01.svg">
...
<img src="src/test/puml/ch03/minMaxExamples02.svg">
...
![Download](src/test/puml/ch03/DecimalScaling_Class_Diagram.svg)
...
<img src="src/test/puml/ch03/binaryThresholdingExamples01.svg">
...
- 코사인 유사도 구현체인 [**MeanCenteringNormalizer**](https://github.com/r4tings/r4tings-recommender/blob/master/src/main/java/com/r4tings/recommender/model/measures/similarity/CosineSimilarityMeasurer.java) 클래스는 Apache Spark ML 패키지의 추상 클래스인 Transformer 클래스를 상속받아 평점 데이터를 유사도 데이터로 변환하는 transform 메서드를 구현한 클래스입니다.
...
<img src="src/test/puml/ch04/cosineSimilarityExamples01.svg">
...
<img src="src/test/puml/ch04/cosineSimilarityExamples02.svg">
...
<img src="src/test/puml/ch04/pearsonSimilarityExamples01.svg">
...
<img src="src/test/puml/ch04/pearsonSimilarityExamples02.svg">
...
<img src="src/test/puml/ch04/pearsonSimilarityExamples03.svg">

여기에서 ${\mathop{\rm pearson}\nolimits} (u,v)$는 사용자 $u$와 사용자 $v$의 피어슨 상관계수입니다.

(3) 아이템 피어슨 유사도는 다음과 같이 정의됩니다.

<img src="src/test/puml/ch04/pearsonSimilarityExamples04.svg">
...
<img src="src/test/puml/ch04/pearsonSimilarityExamples05.svg">
...
<img src="src/test/puml/ch04/euclideanSimilarityExamples01.svg">

여기에서 ${{\mathop{\rm dist}\nolimits} _{euclidean}}(u,v)$는 사용자 $u$와 사용자 $v$의 유클리드 거리입니다.

(3) 아이템 유클리드 유사도는 다음과 같이 정의됩니다.

<img src="src/test/puml/ch04/euclideanSimilarityExamples02.svg">
...
<img src="src/test/puml/ch04/extendedJaccardSimilarityExamples01.svg">

(2) 임의의 벡터 ${{\bf{x}}_a}$와 ${{\bf{x}}_b}$ 간의 자카드 계수(Jaccard Coefficient)는 다음과 같이 정의됩니다.

<img src="src/test/puml/ch04/extendedJaccardSimilarityExamples02.svg">
...
<img src="src/test/puml/ch07/termFrequencyInverseDocumentFrequencyExamples01.svg">
...
이 예제에서는 R4tings Recommender에서 사용할 수 있는 모든 기능을 다루지는 않지만 초급자 및 고급자 등 대부분의 사용자에게 필요한 기능을 다루고자 하였습니다. 

예제에 대한 도움이 필요하거나 여기에서 다루지 않은 내용이나 기능 요청이 있는 경우 **[ISSUES](https://github.com/r4tings/r4tings-recommender-examples/issues/)** 에 등록하세요.

**[DISCUSSIONS](https://github.com/r4tings/r4tings-recommender-examples/discussions/)** 을 통해서도 질문하실 수 있습니다. 
...
모든 예제 코드는 Released under the Open Publication License, v1.0 or later.

<br/>

<div align="right">
 
~~[EN]~~ | [**KO**]((https://github.com/r4tings/r4tings-recommender/blob/master/README.md)) |  ~~JP~~

</div>

<!--

**_R4tings Recommender Examples<sup>[1](#footnote_1)</sup>_** 의 자세한 설명은 **_[WIKI](https://github.com/r4tings/r4tings-recommender-examples/wiki/)_** 에서 확인할 수 있습니다.
> <a name="footnote_1">1</a>: 모든 예제는 Java 언어로 작성되었으며, Gradle 빌드 환경에서 테스트 되었습니다.

“**R4tings Recommender 오픈 소스 추천 엔진 패키지**”는 JVM(Java와 Scala)과 [Apache Spark](https://spark.apache.org/) 기반의 학술 연구/상용 목적의 추천 시스템을 구현하기 위한 오픈 소스 추천 엔진 패키지로 통계나 기계 학습 기반 추천 모델들의 기본 구현체인 “**[R4tings Recommender](https://github.com/r4tings/r4tings-recommender)**”와 응용 예제들인 “**R4tings Recommender Examples**”를 통해 추천 과정을 단계별로 분해하여 흐름을 쉽게 파악하고, 어느 도메인에서도 손쉽게 수정하거나 확장 또는 재사용할 수 있고, 이를 하나의 파이프라인으로 연결하여 병렬 처리 할 수 있다.
...
#### Step 2-4 외부 데이터셋 내려받기

<br/>

여기에서는 테스트 클래스인 [**DatasetLoadTest**](src/test/java/com/r4tings/recommender/examples/ch02/DatasetLoadTest.java) 클래스의 테스트 메서드인 downloadExtenalDatasets를 실행하여 외부 데이터셋을 내려받고 압축을 해제합니다. 

다음과 같이 명령줄 인터페이스(CLI, Command line interface)에서 빌드 도구인 Gradle Wrapper로 DatasetLoadTest 클래스의 테스트 메서드인 downloadExtenalDatasets를 실행하고 실행 결과를 살펴봅니다.

```
./gradlew :test --tests com.r4tings.recommender.examples.ch02.DatasetLoadTest.downloadExternalDatasets
```

https://github.com/r4tings/r4tings-recommender-examples/assets/123946859/b0079e57-6d14-48e8-8d95-ecd2064c462e

Gradle Wrapper로 DatasetLoadTest 클래스의 테스트 메서드인 downloadExtenalDatasets를 실행 후, R4tings Recommender Examples 프로젝트의 dataset 폴더 구조는 다음과 같습니다
...
예제 테스트 클래스인 DatasetLoadTest 클래스의 테스트 메서드인 downloadExternalDatasets 실행 결과를 살펴봅니다.

* [downloadExternalDatasets](./src/test/java/com/r4tings/recommender/examples/ch02/DatasetLoadTest.java#L42) 

다음과 같이 명령줄 인터페이스(CLI, Command line interface)에서 빌드 도구인 Gradle Wrapper로 DatasetLoadTest 클래스의 테스트 메서드인 downloadExternalDatasets를 실행해 봅니다.
...
* [bookCrossingDatasetExamples](./src/test/java/com/r4tings/recommender/examples/ch02/DatasetLoadTest.java#L63)
...
```
./gradlew :test --tests com.r4tings.recommender.examples.ch02.DatasetLoadTest.bookCrossingDatasetExamples
```
...
#### MovieLens Latest 데이터셋

<br/>

예제 테스트 클래스인 DatasetLoadTest 클래스의 테스트 메서드인 movieLensDatasetExamples 실행 결과를 살펴봅니다.

* [movieLensDatasetExamples](./src/test/java/com/r4tings/recommender/examples/ch02/DatasetLoadTest.java#L127)

다음과 같이 명령줄 인터페이스(CLI, Command line interface)에서 빌드 도구인 Gradle Wrapper로 DatasetLoadTest 클래스의 테스트 메서드인 movieLensDatasetExamples를 실행해 봅니다.

```
./gradlew :test --tests com.r4tings.recommender.examples.ch02.DatasetLoadTest.movieLensDatasetExamples
```
