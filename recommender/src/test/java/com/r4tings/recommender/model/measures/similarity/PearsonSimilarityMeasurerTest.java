...
@Slf4j
class PearsonSimilarityMeasurerTest extends AbstractSparkTests {

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "#{index} run with [{arguments}]")
  @CsvSource({
    "dataset/r4tings/ratings.csv, USER, true, , , , , , 'u4, u5, 1d'",
    "dataset/r4tings/ratings.csv, ITEM, true, , , , , , 'i3, i1, 1d'",
  })
  @interface PearsonSimilarityCsvSource {}

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "[{arguments}] #{index}")
  @CsvFileSource(
      resources = "/com/r4tings/recommender/model/measures/similarity/pearson_similarity.csv",
      numLinesToSkip = 1)
  @interface PearsonSimilarityCsvFileSource {}

  // @PearsonSimilarityCsvSource
  @PearsonSimilarityCsvFileSource
  @Tag("Similarity")
  @DisplayName("PearsonSimilarity")
