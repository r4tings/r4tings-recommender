...
@Slf4j
class SimpleMatchingSimilarityMeasurerTest extends AbstractSparkTests {

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "[{arguments}] #{index}")
  @CsvFileSource(
      resources = "/com/r4tings/recommender/model/measures/similarity/binary/smc_similarity.csv",
      numLinesToSkip = 1)
  @interface SMCSimilarityCsvFileSource {}
