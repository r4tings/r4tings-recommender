...
@Slf4j
class EuclideanSimilarityMeasurerTest extends AbstractSparkTests {

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "#{index} run with [{arguments}]")
  @CsvSource({
    "dataset/r4tings/ratings.csv, USER, true, , , , , , 'u4, u5, 0.309017 '",
    "dataset/r4tings/ratings.csv, ITEM, true, , , , , , 'i3, i1, 0.5857864'",
  })
  @interface EuclideanSimilarityCsvSource {}

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "[{arguments}] #{index}")
  @CsvFileSource(
      resources = "/com/r4tings/recommender/model/measures/similarity/euclidean_similarity.csv",
      numLinesToSkip = 1)
  @interface EuclideanSimilarityCsvFileSource {}

  @EuclideanSimilarityCsvSource
  @EuclideanSimilarityCsvFileSource
  @Tag("Similarity")
  @DisplayName("Euclidean Similarity")
