...
import com.r4tings.recommender.model.measures.similarity.JaccardSimilarityMeasurer;
...
@Slf4j
class JaccardSimilarityMeasurerTest extends AbstractSparkTests {
  ...
  @CsvFileSource(
      ...
      numLinesToSkip = 1)
  @interface JaccardSimilarityCsvFileSource {}
  ...
  @interface JaccardSimilarityCsvSource {}

  @JaccardSimilarityCsvSource
  @JaccardSimilarityCsvFileSource
  @Tag("Binary Similarity")
  ...
  void testWithExample(
    ...
    JaccardSimilarityMeasurer measurer =
        new JaccardSimilarityMeasurer()
            .setGroup(group)
            .setVerbose(verbose)
            .setIds(ids)
            .setUserCol(userCol)
