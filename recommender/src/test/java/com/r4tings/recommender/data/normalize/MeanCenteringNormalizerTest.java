...
@Slf4j
class MeanCenteringNormalizerTest extends AbstractSparkTests {

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "#{index} run with [{arguments}]")
  @CsvSource({
    "dataset/r4tings/ratings.csv,     , true, , , , 'u4, i1,         0d'",
    "dataset/r4tings/ratings.csv, USER, true, , , , 'u4, i1, -0.3333333'",
    "dataset/r4tings/ratings.csv, ITEM, true, , , , 'u4, i1,  0.8333333'",
  })
  @interface MeanCenteringCsvSource {}

  @Retention(RetentionPolicy.RUNTIME)
  @ParameterizedTest(name = "[{arguments}] #{index}")
  @CsvFileSource(
      resources = "/com/r4tings/recommender/data/normalize/mean_centering.csv",
      numLinesToSkip = 1)
  @interface MeanCenteringCsvFileSource {}

  // @MeanCenteringCsvSource
  @MeanCenteringCsvFileSource
  @Tag("Normalization")
  @DisplayName("Mean Centering")
