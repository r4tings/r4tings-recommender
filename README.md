...
> 
> Windows OS에서의 전체 예제 실행은 [`getting-started-r4tings-recommender-on-windows.ps1`](https://github.com/r4tings/r4tings-recommender/blob/main/getting-started-r4tings-recommender-on-windows.ps1) 를 참고하세요.
